...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate prob-vs-steps simulation data and save/update JSON.")
    parser.add_argument("--grid-size", type=int, default=16)
    parser.add_argument("--bl-prob", type=float, default=0.01)
    parser.add_argument("--ells", type=str, default="4/N,1/N,0")
    parser.add_argument("--step-factor", type=float, default=8.0)
    parser.add_argument("--shots", type=int, default=50)
    parser.add_argument("--output", "-o", type=str, default="prob-vs-steps-data.json")
