...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate prob-vs-steps simulation data and save/update JSON.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    parser.add_argument("--grid-size", type=int, default=16, help="Grid side length L.")
    parser.add_argument("--bl-prob", type=float, default=0.01, help="Broken-link probability p.")
    parser.add_argument("--ells", type=str, default="4/N,1/N,0", help="Comma-separated ell values.")
    parser.add_argument(
        "--step-factor",
        type=float,
        default=8.0,
    ...
    parser.add_argument("--output", "-o", type=str, default="prob-vs-steps-data.json", help="Output JSON filename.")
